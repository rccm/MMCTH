...
*/  A number of these variables come from the get_spec_info routine
      ...
      character*80 ProgramName, FieldNames(80), DimNames(80)
      character*80 DataNames(80)
...
*/  Define the global variables
     ...
     &         0,2)
      ...
      Else If (ProgramName .eq. "MOD07") then
         srtn=sfsattr(sdid,"ScaleFactor_AddOffset_Application",
     &                DFNT_CHAR8,48,
     ...
     &         0,2)
         ...
         srtn=sfsattr(sdid,"Pressure_Levels",
     &                DFNT_CHAR8,96,
     & "5, 10, 20, 30, 50, 70, 100, 150, 200, 250, 300, 400, 500, "//
     & "620, 700, 780, 850, 920, 950, 1000 hPa")
         if( srtn .ne. 0) then
            call message( 'setup_create_hdf',
     &         'Error defining dimensions for output file: swdefdim ' //
     &         ' [OPERATOR ACTION: Notify SDST.]',
