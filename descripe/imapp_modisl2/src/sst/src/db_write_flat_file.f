...
C
C
      integer function db_write_flat_file(
     &			    	        req_scan,	 	
     &				        req_samples,
     &				        req_lines,
     &				        req_band,
...
c --- SUCCESS: all records for band were written
      ...
      db_write_flat_file = 0
      return

c --- FAILED: did not write all records 
9999  continue
      db_write_flat_file = -7
      return
