...
C-----------------------------------------------------------------------
          ...
          IBTS = ibits(count(I),0,1)
          CALL BYTE_SET(IBTS,0,QA_Temp)
          IBTS = ibits(count(I),1,2)
          CALL BYTE_SET(IBTS,1,QA_Temp)
          IBTS = ibits(count(I),3,1)
          CALL BYTE_SET(IBTS,3,QA_Temp)
          IBTS = ibits(count(I),4,1)
          CALL BYTE_SET(IBTS,4,QA_Temp)
          IBTS = ibits(count(I),5,1)
          CALL BYTE_SET(IBTS,5,QA_Temp)
          IBTS = ibits(count(I),6,2)
          CALL BYTE_SET(IBTS,6,QA_Temp)
