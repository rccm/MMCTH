...
int modis_grib_driver_( long *inlun1, long *outlun1,
                        long *inlun2, long *outlun2,
                        long *inlun3, long *outlun3,
                        long *met_year, long *met_month, long *met_day, long *met_hour,
                        long *ozn_year, long *ozn_month, long *ozn_day, long *ozn_hour,
                        long *ice_year, long *ice_month, long *ice_day, long *ice_hour,
