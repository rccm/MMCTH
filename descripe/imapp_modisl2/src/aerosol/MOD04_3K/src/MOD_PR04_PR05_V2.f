...
!      RTN_NCEP = rtn_met + rtn_ozn 

! Reading only grib file. Reading Ozone from Grib file 4/2013 Shana Mattoo
...
c            CALL MOD_PR05_V2(modis_flag,idebug,MODFIL_MOD05,MinSolarZenithAngle,RTN_NCEP)
