...
c---------------------------------------------------------------------
       ...
       if (ProgramName .EQ. "MOD06") then
          ...
          HistoryCount = 1
          history = "$Id: MOD06_L2.CDL.fs,v 1.12 2013/04/09 18:38:31 wind Exp $"
     ...
     $ "Cell_Across_Swath_5km,Cell_Along_Swath_5km,Band_Number"
             long_name = 
     $ "Observed Brightness Temperature from Cloudy Averaged Radiances in a 5x5 1-km " //
     $ "Pixel Region"
             units_str = "K" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
     ...
     $ " 6 -- undetermined phase" 
          ...
          if (InputName .EQ. "IRP_CTH_Consistency_Flag_1km") then
             NumberType = DFNT_INT8
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Indicates Cloud_Phase_Infrared_1km results changed to ice from water" //
     $ " when cloud_top_method_1km reports valid band 36/35 CO2-slicing result (1=change) "
             units_str = "none" 
             valid_range(1) = 0 
             valid_range(2) = 1 
             Fill_Value = 127 
     ...
     $ "channel retrieval using band 7(2.1um) and either band 1(0.65um), 2(0.86um), or 5(1.2um) " //
     $ " (specified in Quality_Assurance_1km)" //
     $ "from best points: not failed in any way, not marked for clear sky restoral"
             units_str = "micron" 
             valid_range(1) = 0 
             valid_range(2) = 10000 
             Fill_Value = -9999 
          ...
          if (InputName .EQ. "Cloud_Effective_Radius_PCL") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "channel retrieval using band 7(2.1um) and either band 1(0.65um), 2(0.86um), or 5(1.2um) " //
     $ "(specified in Quality_Assurance_1km)" //
     $ "from points identified as either partly cloudy from 250m cloud mask test or 1km cloud edges"
             units_str = "micron" 
             valid_range(1) = 0 
             valid_range(2) = 10000 
             Fill_Value = -9999 
     ...
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Cloud Particle Effective Radius two-" //
     $ "channel retrieval using band 6(1.6um) and either band 1(0.65um), 2(0.86um), or 5(1.2um) " //
     $ " (specified in Quality_Assurance_1km)" //
     $ "from best points: not failed in any way, not marked for clear sky restoral"
             units_str = "micron" 
             valid_range(1) = 0 
          ...
          if (InputName .EQ. "Cloud_Effective_Radius_16_PCL") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Cloud Particle Effective Radius two-" //
     $ "channel retrieval using band 20(3.7um) and either band 1(0.65um), 2(0.86um), or 5(1.2um) " //
     $ "(specified in Quality_Assurance_1km)" //
     $ "from best points: not failed in any way, not marked for clear sky restoral"
             units_str = "micron" 
             valid_range(1) = 0 
          ...
          if (InputName .EQ. "Cloud_Effective_Radius_37_PCL") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "from best points: not failed in any way, not marked for clear sky restoral"
          ...
          if (InputName .EQ. "Cloud_Optical_Thickness_PCL") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "from points identified as either partly cloudy from 250m cloud mask test or 1km cloud edges"
          ...
          if (InputName .EQ. "Cloud_Optical_Thickness_16") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "from best points: not failed in any way, not marked for clear sky restoral"
          ...
          if (InputName .EQ. "Cloud_Optical_Thickness_16_PCL") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "from points identified as either partly cloudy from 250m cloud mask test or 1km cloud edges"
          ...
          if (InputName .EQ. "Cloud_Optical_Thickness_37") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "from best points: not failed in any way, not marked for clear sky restoral"
          ...
          if (InputName .EQ. "Cloud_Optical_Thickness_37_PCL") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Cloud Particle Effective Radius two-" //
     $ "channel retrieval using band 7(2.1um) and band 6(1.6um)" //
     $ "from best points: not failed in any way, not marked for clear sky restoral"
             units_str = "micron" 
             valid_range(1) = 0 
             valid_range(2) = 10000 
          ...
          if (InputName .EQ. "Cloud_Effective_Radius_1621_PCL") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "from best points: not failed in any way, not marked for clear sky restoral"
          ...
          if (InputName .EQ. "Cloud_Optical_Thickness_1621_PCL") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "from best points: not failed in any way, not marked for clear sky restoral"
          ...
          if (InputName .EQ. "Cloud_Water_Path_PCL") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "from best points: not failed in any way, not marked for clear sky restoral"
          ...
          if (InputName .EQ. "Cloud_Water_Path_1621_PCL") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "from points identified as either partly cloudy from 250m cloud mask test or 1km cloud edges"
          ...
          if (InputName .EQ. "Cloud_Water_Path_16") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "from best points: not failed in any way, not marked for clear sky restoral"
          ...
          if (InputName .EQ. "Cloud_Water_Path_16_PCL") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "from points identified as either partly cloudy from 250m cloud mask test or 1km cloud edges"
          ...
          if (InputName .EQ. "Cloud_Water_Path_37") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "from best points: not failed in any way, not marked for clear sky restoral"
          ...
          if (InputName .EQ. "Cloud_Water_Path_37_PCL") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     ...
     $ "(from band 7(2.1um)) Relative Uncertainty (Percent)" //
     $ "from both best points and points identified as cloud edge at 1km resolution or partly cloudy at 250m "
             units_str = "percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
             Fill_Value = -9999 
     ...
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Cloud Effective Particle Radius " //
     $ "(from band 6(1.6um) Relative Uncertainty (Percent)" //
     $ "from both best points and points identified as cloud edge at 1km resolution or partly cloudy at 250m "
             units_str = "percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
     ...
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Cloud Effective Particle Radius " //
     $ " (from band 20(3.7um)) Relative Uncertainty (Percent)" //
     $ "from both best points and points identified as cloud edge at 1km resolution or partly cloudy at 250m "
             units_str = "percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
     ...
     $ "from both best points and points identified as cloud edge at 1km resolution or partly cloudy at 250m " //
     $ "based on the Cloud_Optical_Thickness and Cloud_Effective_Radius results"
             units_str = "percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
             Fill_Value = -9999 
          ...
          if (InputName .EQ. "Cloud_Optical_Thickness_Uncertainty_16") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Cloud Optical Thickness Relative Uncertainty (Percent)" //
     $ "from both best points and points identified as cloud edge at 1km resolution or partly cloudy at 250m " //
     $ "based on the Cloud_Optical_Thickness_16 and Cloud_Effective_Radius_16 results"
             units_str = "percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
             Fill_Value = -9999 
          ...
          if (InputName .EQ. "Cloud_Optical_Thickness_Uncertainty_37") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Cloud Optical Thickness Relative Uncertainty (Percent)" //
     $ "from both best points and points identified as cloud edge at 1km resolution or partly cloudy at 250m " //
     $ "based on the Cloud_Optical_Thickness_37 and Cloud_Effective_Radius_37 results"
             units_str = "percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
             Fill_Value = -9999 
     ...
     $ "from both best points and points identified as cloud edge at 1km resolution or partly cloudy at 250m " //
     $ "based on the Cloud_Water_Path result"
             units_str = "percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
             Fill_Value = -9999 
     ...
     $ " (Percent) using band 7(2.1um) and band 6(1.6um)" //
     $ "from both best points and points identified as cloud edge at 1km resolution or partly cloudy at 250m "
             units_str = "percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
     ...
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Cloud Water Path Relative Uncertainty " //
     $ " (Percent) using band 7(2.1um) and band 6(1.6um)" //
     $ "from both best points and points identified as cloud edge at 1km resolution or partly cloudy at 250m "
             units_str = "percent" 
             valid_range(1) = 0 
          ...
          if (InputName .EQ. "Cloud_Water_Path_Uncertainty_16") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Cloud Water Path Relative Uncertainty (Percent)" //
     $ "from both best points and points identified as cloud edge at 1km resolution or partly cloudy at 250m " //
     $ "using the VNSWIR-1.6um retrieval"
             units_str = "percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
             Fill_Value = -9999 
          ...
          if (InputName .EQ. "Cloud_Water_Path_Uncertainty_37") then
             NumberType = DFNT_INT16
             DimList = 
     $ "Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Cloud Water Path Relative Uncertainty (Percent)" //
     $ "from both best points and points identified as cloud edge at 1km resolution or partly cloudy at 250m " //
     $ "using the VNSWIR-3.7um retrieval"
             units_str = "percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
             Fill_Value = -9999 
     ...
     $ " using cloud emissivity based on cloud optical thickness"
             units_str = "K" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
             Fill_Value = -32768 
     ...
     $ "MODIS Cloud Mask, L2 MOD06 QA Plan" 
          ...
          if (InputName .EQ. "Extinction_Efficiency_Ice") then
             NumberType = DFNT_FLOAT32
             DimList = 
     $ "RadTran_NWL,RadTran_NRE_Ice"
             long_name = 
     $ "Ice Extinction Efficiency from the phase functions used to generate " //
     $ " the forward lookup tables"
             ...
             Cell_Across_Swath_Sampling(3) = 1 
             Cell_Along_Swath_Sampling(1) = 1 
             Cell_Along_Swath_Sampling(2) = 12 
             Cell_Along_Swath_Sampling(3) = 1 
             description(1) = "Ice CE from the phase functions used to generate the forward lookup tables"
     ...
     $ " the forward lookup tables"
          ...
          if (InputName .EQ. "Extinction_Efficiency_Liq") then
             NumberType = DFNT_FLOAT32
             DimList = 
     $ "RadTran_NWL,RadTran_NRE_Liq"
             long_name = 
     $ "Liquid Water CE from the phase functions used to generate the forward lookup tables" 
             ...
             Cell_Across_Swath_Sampling(3) = 1 
             Cell_Along_Swath_Sampling(1) = 1 
             Cell_Along_Swath_Sampling(2) = 18 
             Cell_Along_Swath_Sampling(3) = 1 
             description(1) = "Liquid Water CE from the phase functions used to generate the forward lookup tables"
             Geolocation_Pointer = "Geolocation product not applicable" 
             DescCount = 1 
          End If

          if (InputName .EQ. "Asymmetry_Parameter_Liq") then
             NumberType = DFNT_FLOAT32
             DimList = 
     $ "RadTran_NWL,RadTran_NRE_Liq"
             long_name = 
     $ "Liquid Water Asymmetry Parameter from the phase functions used " //
     $ " to generate the forward lookup tables"
             ...
             Cell_Along_Swath_Sampling(2) = 18 
             Cell_Along_Swath_Sampling(3) = 1 
             description(1) = "Liquid Water Asymmetry Parameter from the phase functions used to generate the forward lookup tables"
             Geolocation_Pointer = "Geolocation product not applicable" 
             DescCount = 1 
          End If

          if (InputName .EQ. "Single_Scatter_Albedo_Liq") then
             NumberType = DFNT_FLOAT32
             DimList = 
     $ "RadTran_NWL,RadTran_NRE_Liq"
             long_name = 
     $ "Liquid Water single scatter albedo from the phase functions used " //
     $ " to generate the forward lookup tables"
             units_str = "none" 
             valid_range(1) = 0. 
             valid_range(2) = 1. 
             ...
             Cell_Along_Swath_Sampling(2) = 18 
             Cell_Along_Swath_Sampling(3) = 1 
             description(1) = "Liquid Water SSA from the phase functions used to generate the forward lookup tables"
             Geolocation_Pointer = "Geolocation product not applicable" 
             DescCount = 1 
          End If
     ...
     $ " statistics of cloud mask"
          ...
          if (InputName .EQ. "Retrieval_Failure_Metric") then
             NumberType = DFNT_INT16
             DimList = 
     $ "RFM_nband,Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Retrievals and other information for points that failed to retrieve" //
     $ "via standard solution logic for retrieval using band 7 and either band 1, 2, or 5 (specified in Quality_Assurance_1km)"
             units_str = "by plane in order: 1-none, 2-micron, 3-percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
             Fill_Value = -9999 
             scale_factor = 0.01 
     ...
     $ "      percentage of reflectance" 
          ...
          if (InputName .EQ. "Retrieval_Failure_Metric_16") then
             NumberType = DFNT_INT16
             DimList = 
     $ "RFM_nband,Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Retrievals and other information for points that failed to retrieve" //
     $ "via standard solution logic for retrieval using band 6 and either band 1, 2, or 5 (specified in Quality_Assurance_1km)"
             units_str = "by plane in order: 1-none, 2-micron, 3-percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
             Fill_Value = -9999 
     ...
     $ "      percentage of reflectance" 
          ...
          if (InputName .EQ. "Retrieval_Failure_Metric_37") then
             NumberType = DFNT_INT16
             DimList = 
     $ "RFM_nband,Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Retrievals and other information for points that failed to retrieve" //
     $ "via standard solution logic for retrieval using band 20 and either band 1, 2, or 5 (specified in Quality_Assurance_1km)"
             units_str = "by plane in order: 1-none, 2-micron, 3-percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
             Fill_Value = -9999 
     ...
     $ "      percentage of reflectance" 
          ...
          if (InputName .EQ. "Retrieval_Failure_Metric_1621") then
             NumberType = DFNT_INT16
             DimList = 
     $ "RFM_nband,Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Retrievals and other information for points that failed to retrieve" //
     $ "via standard solution logic for retrieval using band 6 and band 7"
             units_str = "by plane in order: 1-none, 2-micron, 3-percent" 
             valid_range(1) = 0 
             valid_range(2) = 20000 
             Fill_Value = -9999 
     ...
     $ "      percentage of reflectance" 
          ...
          if (InputName .EQ. "Atm_Corr_Refl") then
             NumberType = DFNT_INT16
             DimList = 
     $ "ACR_nband,Cell_Across_Swath_1km,Cell_Along_Swath_1km"
             long_name = 
     $ "Atmospherically corrected reflectance used during cloud optical " //
     ...
     $ "                                                    100 = Unknown Cloud" 
             description(39) = 
     $ "  6              1.6-" // 
     $ " 2.1 Retrieval Outcome          0 = Failed/No attempt"
             description(40) = 
     $ "                                                    1 = Successful" 
             description(41) = 
     $ " Byte 2 -----------------------------------------------------------------" 
     ...
     $ "                                                    100 = Unknown Cloud" 
             description(107) = 
     $ "  3            VNSWIR-" // 
     $ " 1.6 Retrieval Outcome         0 = Failed/No attempt"
             description(108) = 
     $ "                                                    1 = Successful" 
             description(109) = 
     ...
     $ "                                                    100 = Unknown Cloud" 
             description(114) = 
     $ "  7        VNSWIR-" // 
     $ " 1.6 PCL Retrieval Outcome         0 = Failed/No attempt"
             description(115) = 
     $ "                                                    1 = Successful" 
             description(116) = 
     $ " Byte 7 -----------------------------------------------------------------" 
     ...
     $ "                                                    100 = Unknown Cloud" 
             description(122) = 
     $ "  3            VNSWIR-" // 
     $ " 3.7 Retrieval Outcome         0 = Failed/No attempt"
             description(123) = 
     $ "                                                    1 = Successful" 
             description(124) = 
     $ "  4,5,6    Retrieval Phase                          000 = No Cloud Mask" 
     ...
     $ "                                                    100 = Unknown Cloud" 
             description(129) = 
     $ "  7        VNSWIR-" // 
     $ " 3.7 PCL Retrieval Outcome         0 = Failed/No attempt"
             description(130) = 
     $ "                                                    1 = Successful" 
             description(131) = 
     $ " Byte 8 -----------------------------------------------------------------" 
     ...
     $ "                                                    100 = Unknown Cloud" 
             description(137) = 
     $ "  3           1.6-" // 
     $ " 2.1 PCL Retrieval Outcome         0 = Failed/No attempt"
             description(138) = 
     $ "                                                    1 = Successful" 
             description(139) = 
     $ "  4,5,6    Retrieval Phase                          000 = No Cloud Mask" 
...
c---------------------------------------------------------------------
       ...
       if (ProgramName .EQ. "MOD06") then
          ...
          DimNumbers(15) = 7
          DimNames(16) = "RadTran_NRE_Ice"
          DimNumbers(16) = 12
          DimNames(17) = "RadTran_NRE_Liq"
          DimNumbers(17) = 18
          DimNames(18) = "SPI_nband"
          DimNumbers(18) = 2
          DimNames(19) = "RFM_nband"
          DimNumbers(19) = 3
          DimNames(20) = "ACR_nband"
          DimNumbers(20) = 6
          DimNames(21) = "Statistic_Parameter_1km"
          DimNumbers(21) = 17
          DimCount = 21 
          ...
          FieldNames(59) = "IRP_CTH_Consistency_Flag_1km"
          FieldNames(60) = "os_top_flag_1km"
          FieldNames(61) = "cloud_top_pressure_1km"
          FieldNames(62) = "cloud_top_height_1km"
          FieldNames(63) = "cloud_top_temperature_1km"
          FieldNames(64) = "cloud_emissivity_1km"
          FieldNames(65) = "cloud_top_method_1km"
          FieldNames(66) = "surface_temperature_1km"
          FieldNames(67) = "cloud_emiss11_1km"
          FieldNames(68) = "cloud_emiss12_1km"
          FieldNames(69) = "cloud_emiss13_1km"
          FieldNames(70) = "cloud_emiss85_1km"
          FieldNames(71) = "Cloud_Effective_Radius"
          FieldNames(72) = "Cloud_Effective_Radius_PCL"
          FieldNames(73) = "Cloud_Effective_Radius_16"
          FieldNames(74) = "Cloud_Effective_Radius_16_PCL"
          FieldNames(75) = "Cloud_Effective_Radius_37"
          FieldNames(76) = "Cloud_Effective_Radius_37_PCL"
          FieldNames(77) = "Cloud_Optical_Thickness"
          FieldNames(78) = "Cloud_Optical_Thickness_PCL"
          FieldNames(79) = "Cloud_Optical_Thickness_16"
          FieldNames(80) = "Cloud_Optical_Thickness_16_PCL"
          FieldNames(81) = "Cloud_Optical_Thickness_37"
          FieldNames(82) = "Cloud_Optical_Thickness_37_PCL"
          FieldNames(83) = "Cloud_Effective_Radius_1621"
          FieldNames(84) = "Cloud_Effective_Radius_1621_PCL"
          FieldNames(85) = "Cloud_Optical_Thickness_1621"
          FieldNames(86) = "Cloud_Optical_Thickness_1621_PCL"
          FieldNames(87) = "Cloud_Water_Path"
          FieldNames(88) = "Cloud_Water_Path_PCL"
          FieldNames(89) = "Cloud_Water_Path_1621"
          FieldNames(90) = "Cloud_Water_Path_1621_PCL"
          FieldNames(91) = "Cloud_Water_Path_16"
          FieldNames(92) = "Cloud_Water_Path_16_PCL"
          FieldNames(93) = "Cloud_Water_Path_37"
          FieldNames(94) = "Cloud_Water_Path_37_PCL"
          FieldNames(95) = "Cloud_Effective_Radius_Uncertainty"
          FieldNames(96) = "Cloud_Effective_Radius_Uncertainty_16"
          FieldNames(97) = "Cloud_Effective_Radius_Uncertainty_37"
          FieldNames(98) = "Cloud_Optical_Thickness_Uncertainty"
          FieldNames(99) = "Cloud_Optical_Thickness_Uncertainty_16"
          FieldNames(100) = "Cloud_Optical_Thickness_Uncertainty_37"
          FieldNames(101) = "Cloud_Water_Path_Uncertainty"
          FieldNames(102) = "Cloud_Effective_Radius_Uncertainty_1621"
          FieldNames(103) = "Cloud_Optical_Thickness_Uncertainty_1621"
          FieldNames(104) = "Cloud_Water_Path_Uncertainty_1621"
          FieldNames(105) = "Cloud_Water_Path_Uncertainty_16"
          FieldNames(106) = "Cloud_Water_Path_Uncertainty_37"
          FieldNames(107) = "Above_Cloud_Water_Vapor_094"
          FieldNames(108) = "IRW_Low_Cloud_Temperature_From_COP"
          FieldNames(109) = "Cloud_Phase_Optical_Properties"
          FieldNames(110) = "Cloud_Multi_Layer_Flag"
          FieldNames(111) = "Cirrus_Reflectance"
          FieldNames(112) = "Cirrus_Reflectance_Flag"
          FieldNames(113) = "Cloud_Mask_5km"
          FieldNames(114) = "Quality_Assurance_5km"
          FieldNames(115) = "Cloud_Mask_1km"
          FieldNames(116) = "Extinction_Efficiency_Ice"
          FieldNames(117) = "Asymmetry_Parameter_Ice"
          FieldNames(118) = "Single_Scatter_Albedo_Ice"
          FieldNames(119) = "Extinction_Efficiency_Liq"
          FieldNames(120) = "Asymmetry_Parameter_Liq"
          FieldNames(121) = "Single_Scatter_Albedo_Liq"
          FieldNames(122) = "Cloud_Mask_SPI"
          FieldNames(123) = "Retrieval_Failure_Metric"
          FieldNames(124) = "Retrieval_Failure_Metric_16"
          FieldNames(125) = "Retrieval_Failure_Metric_37"
          FieldNames(126) = "Retrieval_Failure_Metric_1621"
          FieldNames(127) = "Atm_Corr_Refl"
          FieldNames(128) = "Quality_Assurance_1km"
