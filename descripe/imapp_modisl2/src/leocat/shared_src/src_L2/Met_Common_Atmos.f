...
C        LUN_IS_422509              (Atmos_ECSMET.inc)
...
c--------retrieve the LOCALGRANULEID of MODIS L1 products 
     ...
     2             LUN .EQ. LUN_Is_422509 .OR.
     3             LUN .EQ. LUN_Is_600000 .OR.
     4             LUN .EQ. LUN_Is_700000 .OR.
     5             LUN .EQ. LUN_Is_700001 .OR.
     6             LUN .EQ. LUN_Is_700002 .OR.
     7             LUN .EQ. LUN_Is_430001) Then
...
C
C !REVISION HISTORY:
C  rhucek 12/16/06:  Initialized work_buf to BLANK
C
C
C !TEAM-UNIQUE HEADER:
C
...
C PARAMETER declarations
      ...
      parameter    ( MAX_ESDT_Name_LEN = 11 )

      integer        MAX_MODIS_FNAME_LEN
      parameter    ( MAX_MODIS_FNAME_LEN = 47 )
