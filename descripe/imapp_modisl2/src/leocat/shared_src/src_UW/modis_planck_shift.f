...
C
C!OUTPUT PARAMETERS:
C    MODIS_PLANCK_SHIFT  Planck radiance (units are determined by UNITS)
...
c     TERRA MODIS DETECTOR-AVERAGED SPECTRAL RESPONSE WITH SPECTRAL SHIFT
c     Band 27: +4.0 1/cm
c     Band 28:  2.0 1/cm
c     Band 30:  1.0 1/cm
c     Band 34: +0.8 1/cm
...
c ... Get the coefficients for Terra or Aqua
     ...
     &         platform_name(1:4) .eq. 'AQUA') then
        ...
        call message('modis_planck_shift.f',
