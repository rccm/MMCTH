...
c NDVIfile      name of NDVI file from LEOCAT global attribute
c threshfile    name of thresholds file from LEOCAT global attribute
c
c!Output Parameters:
...
c      Input_LRN(6)  = LRN_THR_PAR 
      Input_LRN(6)  = NO_SET_UR  ! get from LEOCAT C6 code
