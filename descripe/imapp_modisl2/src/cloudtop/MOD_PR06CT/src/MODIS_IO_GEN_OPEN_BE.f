      SUBROUTINE MODIS_IO_GEN_OPENF_BE(FILE_PCF_INDEX,FILE_ACCESS, 
...
C OPEN FILE USING SDPTK GENERIC FILE OPEN FUNCTION 
      ...
      RETURNSTATUS = PGS_IO_GEN_OPENF_BE(FILE_PCF_INDEX, FILE_ACCESS,
     &               RECORD_LENGTH, FILE_HANDLE, FILE_VERSION)
...
C MESSAGES TO LOG FILES.
     ...
     &        INFO_STRING,'MODIS_IO_GEN_OPENF_BE')
      ELSE
