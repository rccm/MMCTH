     ...
     4                     V_flag, V_code, Data_size, error_flag )

      implicit none

      include 'PGS_PC.f'
      include 'PGS_MODIS_39500.f'
      include 'L1B_Reader_V2.2.inc'
      include 'mapi.inc'
...
C    integer   V_code     3-D buffer containing error codes when earth
C                         view data is not valid - otherwise contains
C                         -1s for missing data and 0s for valid data.
...
C
C    Named Constants:
C     BAND_IS_*                   (L1B_Reader_V2.2.inc)
C     DIM_NUM_CH                  (L1B_Reader_V2.2.inc)
C     DIM_NUM_TRACK               (L1B_Reader_V2.2.inc)
C     DIM_NUM_XTRACK              (L1B_Reader_V2.2.inc)
C     FAIL                        (L1B_Reader_V2.2.inc)
C     MAX_L1B_NAME_SIZE           (L1B_Reader_V2.2.inc)
C     LINES_PER_SCAN_1KM          (L1B_Reader_V2.2.inc)
C     PIXELS_PER_FRAME_250M       (L1B_Reader_V2.2.inc)
C     MAX_FRAMES_PER_SCAN         (L1B_Reader_V2.2.inc)
C     MAX_NUM_ARRAYS              (L1B_Reader_V2.2.inc)
C     MAX_NUM_CHANNELS            (L1B_Reader_V2.2.inc)
C     MAX_NUM_CAL_TYPES           (L1B_Reader_V2.2.inc)
C     NUM_L1B_FILES               (L1B_Reader_V2.2.inc)
C     SUCCEED                     (L1B_Reader_V2.2.inc)
C
C
...
c-----Function argument declarations
     ...
     2     V_flag(BufSize_Xtrack,BufSize_Track)
      ...
      integer V_code(BufSize_Xtrack,BufSize_Track,LAST_MODIS_BAND)
...
C    Named Constants:
C        BAND_IS_*         (L1B_Reader_V2.2.inc)
C        CAL_IS_*          (L1B_Reader_V2.2.inc)
C        FAIL              (L1B_Reader_V2.2.inc)
C        FIRST_*_BAND      (L1B_Reader_V2.2.inc)
C        HIGH_GAIN         (L1B_Reader_V2.2.inc)
C        LAST_*_BAND       (L1B_Reader_V2.2.inc)
C        LOW_GAIN          (L1B_Reader_V2.2.inc)
C        P_SDID            (mapi.inc)
C        RESOL_IS_*        (L1B_Reader_V2.2.inc)
C        SUCCEED           (L1B_Reader_V2.2.inc)
C
C  Internals:
C    Subroutines:
...
C        HIGH_GAIN         (L1B_Reader_V2.2.inc)
C        LAST_*_BAND       (L1B_Reader_V2.2.inc)
C        LINES_PER_SCAN_*  (L1B_Reader_V2.2.inc)
C        RESOL_IS_*        (L1B_Reader_V2.2.inc)
C
C !END
C---------------------------------------------------------------------
...
C     MAX_NUM_ARRAYS             (L1B_Reader_V2.2.inc)
C     MAX_NUM_CHANNELS           (L1B_Reader_V2.2.inc)
C     MAX_NUM_DIMS               (L1B_Reader_V2.2.inc)
C     MAX_NUM_CAL_TYPES          (L1B_Reader_V2.2.inc)
C     NUM_L1B_FILES              (L1B_Reader_V2.2.inc)
C
C    Variables and Arrays
C     EV_Name                    (L1B_Reader_V2.2.inc)
C     Name_Of_Offset             (L1B_Reader_V2.2.inc)
C     Name_Of_Scale              (L1B_Reader_V2.2.inc)
C
C
C  Local Variables
C  ---------------
