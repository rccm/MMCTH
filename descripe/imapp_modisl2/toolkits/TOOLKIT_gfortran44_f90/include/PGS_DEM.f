...
!       14-Sep-11 Abe Taaheri added tags for 500m (15 arcsec) resolution
! END_FILE_PROLOG:
!-----------------------------------------------------------------------------
!
!-----------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------
      ...
      integer PGSd_DEM_15ARC
      parameter (PGSd_DEM_15ARC=5)
      ...
      integer PGSd_DEM_LW_FILLVALUE
      parameter (PGSd_DEM_LW_FILLVALUE=-35)
