...
!   file_id = sfstart(trim(mod06_name) // "diag.hdf", DFACC_CREATE)
   
!   var_id = sfcreate(file_id, "ecosystem", DFNT_INT8, 2, myedge)
!   err_code = sfwdata(var_id, mystart, mystride, myedge, eco)
!	print*, "wrote snow_ice, err_code: ", err_code
