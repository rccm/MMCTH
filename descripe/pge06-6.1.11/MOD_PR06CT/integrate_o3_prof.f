      subroutine integrate_o3_prof(toplev, botlev, ozone, o3ppmv)


      include 'mod06uw_data.inc'
      include 'mod06uw_debug.inc'

      integer toplev, botlev
      real ozone(plev), o3ppmv
...
c ... Define 101 pressure levels.
     ...
     +  958.5911,  986.0666, 1013.9476, 1042.2319, 1070.9170, 1100.0000/
      ...
      do kk = toplev, botlev - 1

        dp = abs( pp(kk) - pp(kk+1) )
        do3 = (ozone(kk) + ozone(kk+1)) / 2.0
        o3ppmv = o3ppmv + (dp * do3)
c       write(h_output,'(i5,6f10.4)') kk,pp(kk),ozone(kk),dp,do3,o3ppmv
      enddo

c     write(h_output,'(''integrated ozone total (ppmv): '',f12.4)') o3ppmv 
