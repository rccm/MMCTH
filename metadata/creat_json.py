...
#### 
   example usage:  python creat_json.py --mmcth ./temp/MODMISR_L2_CP_061_A2015112.1010_0422_O081609_MM_V00.nc
####
...
def main():
    ...
    ap.add_argument(
        "--mod03-root",
        default="/data/gdi/satellite/TerraDataArchive/MODIS/MOD03",
    ...
    ap.add_argument("--collection-version", default="V00", help="CollectionReference.Version (e.g., V01)")
    ...
    ap.add_argument("-o", "--out", default=None, help="Output file name (must end with .cmr.json)")
    ...
    if not out_name.endswith(".cmr.json"):
        raise ValueError(f"Output metadata filename must end with '.cmr.json', got: {out_name}")
