...
c       if(line .eq. 6 .and. pixel .eq. 1256) then
          write(h_output,'(''Profile Date: '',5i10)') (met_date(jj),jj=1,4), jday
     ...
     &      o3prof1(3,mid_px,mid_ln),o3prof1(2,mid_px,mid_ln),o3prof1(1,mid_px,mid_ln)
          ...
          write(h_output,'(''Atm level, pressure, temperature, '',
     &      ''water vapor, ozone, transmittances (36,35,34,33,31,29,32)'')')
          do k=1,plev
            write(h_output,'(i4,11f10.4)') k,pp(k),tp(k),w(k),adj_ozone(k),
